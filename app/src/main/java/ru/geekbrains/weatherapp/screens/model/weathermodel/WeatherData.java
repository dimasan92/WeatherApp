...
public class WeatherData implements IWeatherData {
    ...
    public void request(String city) {
        mOpenWeather.loadWeather(city, UNIT_FORMAT_METRIC, OPEN_WEATHER_KEY)
                .enqueue(new Callback<WeatherResponce>() {
                    @Override
                    public void onResponse(@NonNull Call<WeatherResponce> call,
                                           @NonNull Response<WeatherResponce> response) {
                    ...
                    @Override
                    public void onFailure(@NonNull Call<WeatherResponce> call,
                                          @NonNull Throwable t) {
