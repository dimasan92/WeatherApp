package ru.geekbrains.weatherapp.screens.welcome.list;
...
public class WelcomeAdapter extends RecyclerView.Adapter<WelcomeAdapter.CityHolder> {

    private List<String> mCities;
    private IWelcomePresenter mPresenter;

    public WelcomeAdapter(List<String> cities, IWelcomePresenter presenter) {
        mCities = cities;
